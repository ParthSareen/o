...
func (c *recordingCompactor) ShouldCompact(_ CompactionRequest) (CompactionTrigger, bool) {
	return "", false
}
...
func (c *oversizedCompactor) ShouldCompact(_ CompactionRequest) (CompactionTrigger, bool) {
	return "", false
}
